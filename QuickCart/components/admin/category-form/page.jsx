      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full text-center">
            <h2 className="text-2xl font-bold mb-4 text-green-600">¡Categoría Agregada Correctamente!</h2>
            <p className="mb-6 text-gray-700">La categoría se ha guardado en la base de datos.</p>
            <button
